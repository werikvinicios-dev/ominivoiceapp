...
- **A sessão do Colab é temporária.** Sem o Drive montado, tudo se perde ao
  fim da sessão.
- **A porta é escolhida automaticamente.** O Colab já usa a 8080, então o
  lançador procura uma livre e confere que quem responde nela é mesmo o
  Studio, e não outro serviço.
